...
const AgentDetail: NextPage = ({ initialInput, initialComment, ...props }: any) => {
	...
	const [likeTartgetProperty] = useMutation(LIKE_TARGET_PROPERTY);
	...
	const createCommentHandler = async () => {
		try {
			...
			if(user._id === agent?._id) throw new Error('Cannot write a review for yourself');;
